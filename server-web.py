    ...
    try:
        async for message in websocket:
            ...
            try:
                ...
                # --- ОТПРАВКА СООБЩЕНИЯ (с проверкой прав в канале) ---
                ...
                # --- ОТПРАВКА СТИКЕРА (такая же проверка) ---
                ...
                # --- ОТПРАВКА ГОЛОСОВОГО (аналогично) ---
